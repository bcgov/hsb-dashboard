...
data-service () {
  ...
  # ORIGINAL: docker build -t hsb:data-service -f src/data-service/Dockerfile . --no-cache --force-rm
  docker build -t hsb:data-service -f src/data-service/Dockerfile . --force-rm
