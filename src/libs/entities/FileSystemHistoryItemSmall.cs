...
public class FileSystemHistoryItemSmall : Auditable
{
    #region Properties
    /// <summary>
    ...
    #region Constructors
    protected FileSystemHistoryItemSmall() { }

    public FileSystemHistoryItemSmall(string serverItemId, JsonDocument fileSystemItemData, JsonDocument configurationItemData)
    {
    ...
    public FileSystemHistoryItemSmall(FileSystemItem entity)
    {
