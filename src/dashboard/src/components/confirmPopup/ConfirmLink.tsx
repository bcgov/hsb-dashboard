...
export interface IConfirmLinkProps
...
export const ConfirmLink = ({ onClick, children, ...rest }: IConfirmLinkProps) => {
  const setNavigateTo = useNavigateStore((state) => state.setNavigateTo);
  const enableNavigate = useNavigateStore((state) => state.enableNavigate);
